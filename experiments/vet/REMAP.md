# Remap Manifest — mycelium-lint → lint
...
|---|---|---|---|---|---|---|
| `lint.bin.myc-lint` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-lint/src/bin/myc-lint.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
| `lint` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-lint/src/lib.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
